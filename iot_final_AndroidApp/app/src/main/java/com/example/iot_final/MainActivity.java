...
public class MainActivity extends AppCompatActivity {
    ...
    private Button manual_control;
    private Button auto_pilot;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        auto_pilot.setOnTouchListener(new View.OnTouchListener() {
            @Override
            public boolean onTouch(View v, MotionEvent event) {
                if(event.getAction() == MotionEvent.ACTION_DOWN) {
                    String data = "2";
        ...
        manual_control.setOnTouchListener(new View.OnTouchListener() {
            @Override
            public boolean onTouch(View v, MotionEvent event) {
                if(event.getAction() == MotionEvent.ACTION_DOWN) {
                    String data = "1";
...
//        System.out.println("datapoint is " + datapoint);
    ...
    private void initView(){
        ...
        manual_control = findViewById(R.id.manual_control);
        auto_pilot = findViewById(R.id.auto_pilot);
