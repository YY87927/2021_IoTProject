...
def main():
	...
	msg = 'Notify from LINE, Intruder detected!!!'
	hasSent = False
	...
	while True:
		...
		if len(rects)!=0 and name=="Unknown" and not hasSent:
			...
			cv2.imwrite("unknown.jpg", frame.copy())
			picURI="/home/pi/Desktop/IoT_project_source_code/final/FaceDatasetGui/unknown.jpg"
			print("Intruder!")
		...
		payload = {"datapoints":[{"dataChnId":"user","values":{"value":str(name)}}]}
		post_to_mcs(payload)
